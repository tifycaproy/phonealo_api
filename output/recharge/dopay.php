...
$url="http://app.phonealo.net/recharge/cubacel";
$urlOK="http://app.phonealo.net/recharge/cubacel/done?process=".$secure_pay_id.'1';
$urlKO="http://app.phonealo.net/recharge/cubacel/fail?failed=".$secure_pay_id.'0';
//$id=time();
$id= $pedidotpv;
